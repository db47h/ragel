...
//go:generate ragel -Z -G2 csv.rl -o csv.rl.go
//go:generate sed -i "1s|.*|// Code generated by ragel. DO NOT EDIT.|" csv.rl.go
...
func NewCSVParser(fileName string, r io.Reader) *Parser {
	// csv is defined in csv.go, generated from csv.rl by
	// the command `ragel -Z -G2 csv.rl`
	return &Parser{
		s: ragel.New(fileName, r, csv{}),
	}
}
